!function(e, t) {
    ...
    var p = function(n) {
        ...
        var e, d, b, o, s, p, h, g, w, l, u, E, T, a, x, m, c, v, y, C = "sizzle" + 1 * new Date, _ = n.document, S = 0, i = 0, D = le(), A = le(), N = le(), I = le(), k = function(e, t) {
            return e === t && (u = !0),
            0
        }, O = {}.hasOwnProperty, t = [], L = t.pop, j = t.push, H = t.push, P = t.slice, q = function(e, t) {
            for (var n = 0, i = e.length; n < i; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, R = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", M = "[\\x20\\t\\r\\n\\f]", F = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", W = "\\[" + M + "*(" + F + ")(?:" + M + "*([*^$|!~]?=)" + M + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + F + "))|)" + M + "*\\]", B = ":(" + F + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + W + ")*)|.*)\\)|)", U = new RegExp(M + "+","g"), K = new RegExp("^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$","g"), $ = new RegExp("^" + M + "*," + M + "*"), Q = new RegExp("^" + M + "*([>+~]|" + M + ")" + M + "*"), V = new RegExp(M + "|>"), z = new RegExp(B), Y = new RegExp("^" + F + "$"), X = {
            ID: new RegExp("^#(" + F + ")"),
            CLASS: new RegExp("^\\.(" + F + ")"),
            TAG: new RegExp("^(" + F + "|[*])"),
            ATTR: new RegExp("^" + W),
        ...
        try {
            H.apply(t = P.call(_.childNodes), _.childNodes),
        ...
        function ae(t, e, n, i) {
            ...
            "string" != typeof t || !t || 1 !== h && 9 !== h && 11 !== h)
                return n;
            if (!i && ((e ? e.ownerDocument || e : _) !== T && E(e),
            e = e || T,
            x)) {
                if (11 !== h && (l = te.exec(t)))
                    if (r = l[1]) {
                ...
                if (d.qsa && !I[t + " "] && (!m || !m.test(t)) && (1 !== h || "object" !== e.nodeName.toLowerCase())) {
                    if (c = t,
                    f = e,
                    1 === h && V.test(t)) {
        ...
        E = ae.setDocument = function(e) {
            ...
            x = !s(T),
            _ !== T && (n = T.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", r, !1) : n.attachEvent && n.attachEvent("onunload", r)),
            ...
            k = t ? function(e, t) {
                ...
                return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !d.sortDetached && t.compareDocumentPosition(e) === n ? e === T || e.ownerDocument === _ && y(_, e) ? -1 : t === T || t.ownerDocument === _ && y(_, t) ? 1 : l ? q(l, e) - q(l, t) : 0 : 4 & n ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return u = !0,
                ...
                if (!r || !o)
                    return e === T ? -1 : t === T ? 1 : r ? -1 : o ? 1 : l ? q(l, e) - q(l, t) : 0;
                if (r === o)
                    return he(e, t);
        ...
        ae.attr = function(e, t) {
            ...
            var n = b.attrHandle[t.toLowerCase()]
              , i = n && O.call(b.attrHandle, t.toLowerCase()) ? n(e, t, !x) : void 0;
        ...
        (b = ae.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return X.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && z.test(n) && (t = p(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                    e[2] = n.slice(0, t)),
                    e.slice(0, 3))
                }
            },
                ...
                CHILD: function(p, e, t, g, m) {
                    ...
                    : function(e, t, n) {
                        ...
                        if (c) {
                            ...
                            !1 === d)
                                for (; (s = ++a && s && s[u] || (d = a = 0) || l.pop()) && ((_ ? s.nodeName.toLowerCase() !== f : 1 !== s.nodeType) || !++d || (h && ((r = (o = s[C] || (s[C] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] = [S, d]),
                                s !== e)); )
                                    ;
                ...
                if (t = b.relative[e[a].type])
                    ...
                    if ((t = b.filter[e[a].type].apply(null, e[a].matches))[C]) {
                        for (n = ++a; n < i && !b.relative[e[n].type]; n++)
                            ;
                        return Te(1 < a && we(c), 1 < a && _e(e.slice(0, a - 1).concat({
                            value: " " === e[a - 2].type ? "*" : ""
                        })).replace(K, "$1"), t, a < n && xe(e.slice(a, n)), n < i && xe(e = e.slice(n)), n < i && _e(e))
                    }
                    c.push(t)
                }
            return we(c)
    ...
    (C.fn.init = function(e, t, n) {
        ...
        "string" != typeof e)
            ...
            this.length = 1,
            this) : _(e) ? void 0 !== n.ready ? n.ready(e) : e(C) : C.makeArray(e, this);
    ...
    C.Callbacks = function(i) {
        ...
        var r, e, t, o, s = [], a = [], l = -1, u = {
            add: function() {
                return s && (e && !r && (l = s.length - 1,
                a.push(e)),
                function n(e) {
                    C.each(e, function(e, t) {
                        _(t) ? i.unique && u.has(t) || s.push(t) : t && t.length && "string" !== w(t) && n(t)
                    })
                }(arguments),
                e && !r && n()),
                this
    ...
    C.fn.extend({
        data: function(n, e) {
            ...
            1 === o.nodeType && !X.get(o, "hasDataAttrs"))) {
                for (t = s.length; t--; )
                    s[t] && 0 === (i = s[t].name).indexOf("data-") && (i = V(i.slice(5)),
                    ee(o, i, r[i]));
    ...
    function fe(e, t) {
        for (var n, i, r, o, s, a, l, u = [], c = 0, f = e.length; c < f; c++)
            ...
            u[c] || (i.style.display = "")),
            "" === i.style.display && le(i) && (u[c] = (l = s = o = void 0,
            s = (r = i).ownerDocument,
            a = r.nodeName,
    ...
    C.event = {
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return he.test(t.type) && t.click && A(t, "input") && Ne(t, "click", Ce),
                    !1
                },
                trigger: function(e) {
                    var t = this || e;
                    return he.test(t.type) && t.click && A(t, "input") && Ne(t, "click"),
                    !0
                },
                _default: function(e) {
                    var t = e.target;
        ...
        clone: function(e, t, n) {
            ...
            if (!(y.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || C.isXMLDoc(e)))
                ...
                r = (o = me(e)).length; i < r; i++)
                    ...
                    l = s[i],
                    void 0,
                    "input" === (u = l.nodeName.toLowerCase()) && he.test(a.type) ? l.checked = a.checked : "input" !== u && "textarea" !== u || (l.defaultValue = a.defaultValue);
            if (t)
                if (n)
                    for (o = o || me(e),
                    s = s || me(c),
    ...
    var Fe, We, Be, Ue, Ke, $e, Qe, Ve = new RegExp("^(" + te + ")(?!px)[a-z%]+$","i"), ze = function(e) {
    ...
    function Xe() {
        if (Qe) {
            ...
            re.appendChild($e).appendChild(Qe);
            var e = T.getComputedStyle(Qe);
            Fe = "1%" !== e.top,
    ...
    function Je(e, t, n) {
        ...
        !y.pixelBoxStyles() && Ve.test(s) && Ye.test(t) && (i = a.width,
        r = a.minWidth,
        o = a.maxWidth,
    ...
    (Qe = x.createElement("div")).style && (Qe.style.backgroundClip = "content-box",
    ...
    C.each(["height", "width"], function(e, l) {
        C.cssHooks[l] = {
            get: function(e, t, n) {
                if (t)
                    return !rt.test(C.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? ct(e, l, n) : ae(e, st, function() {
                        return ct(e, l, n)
                    })
            },
            set: function(e, t, n) {
                var i, r = ze(e), o = !y.scrollboxSize() && "absolute" === r.position, s = (o || n) && "border-box" === C.css(e, "boxSizing", !1, r), a = n ? ut(e, l, n, s, r) : 0;
    ...
    C.cssHooks.marginLeft = Ze(y.reliableMarginLeft, function(e, t) {
        if (t)
            return (parseFloat(Je(e, "marginLeft")) || e.getBoundingClientRect().left - ae(e, {
                marginLeft: 0
            }, function() {
    ...
    function yt() {
        dt && (!1 === x.hidden && T.requestAnimationFrame ? T.requestAnimationFrame(yt) : T.setTimeout(yt, C.fx.interval),
        C.fx.tick())
    }
    function _t() {
    ...
    function Et(o, e, t) {
        ...
        for (!function(e, t) {
            ...
            if (n = Et.prefilters[i].call(u, o, c, u.opts))
                return _(n.stop) && (C._queueHooks(u.elem, u.opts.queue).stop = n.stop.bind(n)),
                n;
        return C.map(c, wt, u),
    ...
    C.Animation = C.extend(Et, {
        ...
        prefilters: [function(e, t, n) {
            var i, r, o, s, a, l, u, c, f = "width"in t || "height"in t, h = this, d = {}, p = e.style, g = e.nodeType && le(e), m = X.get(e, "fxshow");
    ...
    C.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === e.getAttribute ? C.prop(e, t, n) : (1 === o && C.isXMLDoc(e) || (r = C.attrHooks[t.toLowerCase()] || (C.expr.match.bool.test(t) ? Tt : void 0)),
    ...
    C.fn.extend({
        ...
        hasClass: function(e) {
            var t, n, i = 0;
            for (t = " " + e + " "; n = this[i++]; )
                if (1 === n.nodeType && -1 < (" " + Dt(At(n)) + " ").indexOf(t))
                    return !0;
            return !1
        }
    });
    ...
    C.extend(C.event, {
        trigger: function(e, t, n, i) {
            ...
            if (o = f = s = n = n || x,
            3 !== n.nodeType && 8 !== n.nodeType && !Ot.test(d + C.event.triggered) && (-1 < d.indexOf(".") && (d = (p = d.split(".")).shift(),
            p.sort()),
            l = d.indexOf(":") < 0 && "on" + d,
            ...
            i || !c.trigger || !1 !== c.trigger.apply(n, t))) {
                if (!i && !c.noBubble && !g(n)) {
                    ...
                    Ot.test(a + d) || (o = o.parentNode); o; o = o.parentNode)
                        h.push(o),
                        s = o;
                ...
                return e.type = d,
                i || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(h.pop(), t) || !z(n) || l && _(n[d]) && !g(n) && ((s = n[l]) && (n[l] = null),
                C.event.triggered = d,
                e.isPropagationStopped() && f.addEventListener(d, kt),
                n[d](),
                e.isPropagationStopped() && f.removeEventListener(d, kt),
    ...
    C.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !C(this).is(":disabled") && Mt.test(this.nodeName) && !Rt.test(e) && (this.checked || !he.test(e))
            }).map(function(e, t) {
                var n = C(this).val();
    ...
    C.extend({
        ...
        ajax: function(e, t) {
            ...
            e = void 0),
            t = t || {};
            var c, f, h, n, d, i, p, g, r, o, m = C.ajaxSetup({}, t), v = m.context || m, y = m.context && (v.nodeType || v.jquery) ? C(v) : C.event, _ = C.Deferred(), b = C.Callbacks("once memory"), w = m.statusCode || {}, s = {}, a = {}, l = "canceled", E = {
                readyState: 0,
            ...
            if (_.promise(E),
            m.url = ((e || m.url || Lt.href) + "").replace(Qt, Lt.protocol + "//"),
            ...
            m.data && (m.processData || "string" == typeof m.data) && (f += (Ht.test(f) ? "&" : "?") + m.data,
            delete m.data),
...
function(e, t) {
        ...
        e._addTouchEventListeners = function() {
            ...
            if (this._touchSupported) {
                var n = function(e) {
                  ...
                  , i = function(e) {
                    t._pointerEvent && se[e.originalEvent.pointerType.toUpperCase()] && (t.touchDeltaX = e.originalEvent.clientX - t.touchStartX),
                    t._handleSwipe(),
    ...
    function Re(e, t) {
        ...
        if (e !== s && t !== s || i.contains(r))
            return function(e) {
                var t = e.nodeName;
                return "BODY" !== t && ("HTML" === t || Pe(e.firstElementChild) === e)
            }(s) ? s : Pe(s);
        var a = qe(e);
        return a.host ? Re(a.host, t) : Re(e, qe(t).host)
    }
    function Me(e, t) {
    ...
    function Ge(e, t, n, i, r) {
        ...
        if ("viewport" === i)
            ...
            var l = void 0;
            "scrollParent" === i ? "BODY" === (l = Oe(ke(t))).nodeName && (l = e.ownerDocument.documentElement) : l = "window" === i ? e.ownerDocument.documentElement : i;
            var u = Ye(l, a, o);
    ...
    function rt(e, n, t) {
        return (void 0 === t ? e : e.slice(0, function(e, t, n) {
            ...
            e.enabled && Ne(t) && (n.offsets.popper = Ve(n.offsets.popper),
    ...
    function lt(e, t, n, i) {
        n.updateBound = i,
        at(e).addEventListener("resize", n.updateBound, {
            passive: !0
        });
        var r = Oe(e);
    ...
    function ut() {
        ...
        this.state = function(e, t) {
            return at(e).removeEventListener("resize", t.updateBound),
    ...
    function ft(n, i) {
        Object.keys(i).forEach(function(e) {
            var t = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(e) && ct(i[e]) && (t = "px"),
            n.style[e] = i[e] + t
        })
    }
    var ht = xe && /Firefox/i.test(navigator.userAgent);
    function dt(e, t, n) {
        var i = it(e, function(e) {
            return e.name === t
        })
    ...
    function mt(e, t) {
        var n = 1 < arguments.length && void 0 !== t && t
          , i = gt.indexOf(e)
          , r = gt.slice(i + 1).concat(gt.slice(0, i));
        ...
        modifiers: {
            ...
            arrow: {
                ...
                fn: function(e, t) {
                    ...
                    return _ = Math.max(Math.min(s[u] - p, _), 0),
                    e.arrowElement = i,
                    e.offsets.arrow = ($e(n = {}, f, Math.round(_)),
                    $e(n, h, ""),
                    n),
                    e
                },
            ...
            flip: {
                ...
                enabled: !0,
                fn: function(d, p) {
                    if (ot(d.instance.modifiers, "inner"))
                        return d;
                    if (d.flipped && d.placement === d.originalPlacement)
                        return d;
                    var g = Ge(d.instance.popper, d.instance.reference, p.padding, p.boundariesElement, d.positionFixed)
                    ...
                    return _.forEach(function(e, t) {
                        ...
                        d.placement = m + (y ? "-" + y : ""),
                        d.offsets.popper = Qe({}, d.offsets.popper, nt(d.instance.popper, d.offsets.reference, d.placement)),
                        d = rt(d.instance.modifiers, d, "flip"))
                    }),
                    d
                },
                behavior: "flip",
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    p = "right" == h ? "HTML" === a.nodeName ? -a.clientWidth + c.right : -l.width + c.right : c.left,
                    s && d)
                    ...
                    return e.attributes = Qe({}, y, e.attributes),
                    e.styles = Qe({}, u, e.styles),
            ...
            applyStyle: {
                ...
                enabled: !0,
                fn: function(e) {
                    return ft(e.instance.popper, e.styles),
                    function(t, n) {
                        Object.keys(n).forEach(function(e) {
                            !1 !== n[e] ? t.setAttribute(e, n[e]) : t.removeAttribute(e)
                        })
                    }(e.instance.popper, e.attributes),
                    e.arrowElement && Object.keys(e.arrowStyles).length && ft(e.arrowElement, e.arrowStyles),
                    e
                },
                onLoad: function(e, t, n, i, r) {
                    var o = Ze(r, t, e, n.positionFixed)
                      , s = Je(n.placement, o, t, e, n.modifiers.flip.boundariesElement, n.modifiers.flip.padding);
        ...
        value: function() {
            return function() {
                if (!this.state.isDestroyed) {
                    ...
                    e.offsets.popper = nt(this.popper, e.offsets.reference, e.placement),
    ...
    function Tt(e, t) {
        ...
        Object.keys(Qe({}, Tt.Defaults.modifiers, i.modifiers)).forEach(function(e) {
            n.options.modifiers[e] = Qe({}, Tt.Defaults.modifiers[e] || {}, i.modifiers ? i.modifiers[e] : {})
        }),
    ...
    Et.Utils = ("undefined" != typeof window ? window : global).PopperUtils,
    Et.placements = pt,
    Et.Defaults = wt;
    var xt = "dropdown"
      , Ct = "bs.dropdown"
      ...
      , Gt = function() {
                ...
                !t) {
                    ...
                    !i.isDefaultPrevented()) {
                        if (!this._inNavbar) {
                            ...
                            "scrollParent" !== this._config.boundary && p(e).addClass(qt),
                            this._popper = new Et(r,this._menu,this._getPopperConfig())
                        }
                        "ontouchstart"in document.documentElement && 0 === p(e).closest(Wt).length && p(document.body).children().on("mouseover", null, p.noop),
                        this._element.focus(),
                        this._element.setAttribute("aria-expanded", !0),
                        p(this._menu).toggleClass(Ot),
                        p(e).toggleClass(Ot).trigger(p.Event(It.SHOWN, n))
                    }
                }
            }
        }
        ...
        e.show = function() {
            if (!(this._element.disabled || p(this._element).hasClass(kt) || p(this._menu).hasClass(Ot))) {
                ...
                p(n).trigger(t),
                t.isDefaultPrevented() || (p(this._menu).toggleClass(Ot),
                p(n).toggleClass(Ot).trigger(p.Event(It.SHOWN, e)))
            }
        }
        ,
        e.hide = function() {
        ...
        e._getPlacement = function() {
            var e = p(this._element.parentNode)
              , t = $t;
            return e.hasClass(Lt) ? (t = Ut,
            p(this._menu).hasClass(Pt) && (t = Kt)) : e.hasClass(jt) ? t = Vt : e.hasClass(Ht) ? t = zt : p(this._menu).hasClass(Pt) && (t = Qt),
            t
        }
        ,
        ...
        u._dataApiKeydownHandler = function(e) {
            if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || p(e.target).closest(Ft).length)) : Nt.test(e.which)) && (e.preventDefault(),
            e.stopPropagation(),
            !this.disabled && !p(this).hasClass(kt))) {
                var t = u._getParentFromElement(this)
                  , n = p(t).hasClass(Ot);
                if (n && (!n || 27 !== e.which && 32 !== e.which)) {
                    var i = [].slice.call(t.querySelectorAll(Bt));
                    if (0 !== i.length) {
    ...
    p(document).on(It.KEYDOWN_DATA_API, Rt, Gt._dataApiKeydownHandler).on(It.KEYDOWN_DATA_API, Ft, Gt._dataApiKeydownHandler).on(It.CLICK_DATA_API + " " + It.KEYUP_DATA_API, Gt._clearMenus).on(It.CLICK_DATA_API, Rt, function(e) {
        e.preventDefault(),
        e.stopPropagation(),
      ...
      , yn = function() {
        ...
        e.show = function(e) {
            ...
            if (!this._isShown && !this._isTransitioning) {
                ...
                p(this._element).on(on.CLICK_DISMISS, gn, function(e) {
                    return t.hide(e)
                }),
        ...
        e._showElement = function(e) {
            ...
            p(this._dialog).hasClass(sn) ? this._dialog.querySelector(dn).scrollTop = 0 : this._element.scrollTop = 0,
    ...
    p(document).on(on.CLICK_DATA_API, pn, function(e) {
        ...
        yn._jQueryInterface.call(p(t), r, this)
    }),
        ...
        for (var n = (new window.DOMParser).parseFromString(e, "text/html"), a = Object.keys(s), l = [].slice.call(n.body.querySelectorAll("*")), i = function(e, t) {
            ...
            r.forEach(function(e) {
                !function(e, t) {
                    ...
                    if (-1 !== t.indexOf(n))
                        return -1 === _n.indexOf(n) || Boolean(e.nodeValue.match(wn) || e.nodeValue.match(En));
      ...
      , $n = function() {
        ...
        e.toggle = function(e) {
            if (this._isEnabled)
                if (e) {
                    ...
                    if (p(this.getTipElement()).hasClass(Rn))
        ...
        e.show = function() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                this._popper = new Et(this.element,r,{
                    placement: a,
                    modifiers: {
                        offset: this._getOffset(),
                        flip: {
        ...
        e.hide = function(e) {
            function t() {
                n._hoverState !== jn && i.parentNode && i.parentNode.removeChild(i),
                n._cleanTipClass(),
        ...
        e.setContent = function() {
            ...
            this.setElementContent(p(e.querySelectorAll(Mn)), this.getTitle()),
            p(e).removeClass(qn + " " + Rn)
        }
        ,
        e.setElementContent = function(e, t) {
            "object" != typeof t || !t.nodeType && !t.jquery ? this.config.html ? (this.config.sanitize && (t = Tn(t, this.config.whiteList, this.config.sanitizeFn)),
        ...
        e._setListeners = function() {
            ...
            this.config.trigger.split(" ").forEach(function(e) {
                if ("click" === e)
                    ...
                    var t = e === Wn ? i.constructor.Event.MOUSEENTER : i.constructor.Event.FOCUSIN
                      , n = e === Wn ? i.constructor.Event.MOUSELEAVE : i.constructor.Event.FOCUSOUT;
        ...
        e._enter = function(e, t) {
            ...
            e && (t._activeTrigger["focusin" === e.type ? Bn : Wn] = !0),
            p(t.getTipElement()).hasClass(Rn) || t._hoverState === jn ? t._hoverState = jn : (clearTimeout(t._timeout),
            t._hoverState = jn,
        ...
        e._leave = function(e, t) {
            ...
            (t = t || p(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget,this._getDelegateConfig()),
            p(e.currentTarget).data(n, t)),
            e && (t._activeTrigger["focusout" === e.type ? Bn : Wn] = !1),
        ...
        e._getConfig = function(e) {
            ...
            g.typeCheckConfig(xn, e, this.constructor.DefaultType),
            e.sanitize && (e.template = Tn(e.template, e.whiteList, e.sanitizeFn)),
            e
        }
        ,
        ...
        e._fixTransition = function() {
            ...
            null === e.getAttribute("x-placement") && (p(e).removeClass(qn),
    ...
    p.fn[xn] = $n._jQueryInterface,
    p.fn[xn].Constructor = $n,
    ...
    p.fn[Qn] = oi._jQueryInterface,
    p.fn[Qn].Constructor = oi,
    ...
    var si = "scrollspy"
      ...
      , Ci = function() {
        function n(e, t) {
            ...
            this._config = this._getConfig(t),
            this._selector = this._config.target + " " + vi + "," + this._config.target + " " + _i + "," + this._config.target + " " + wi,
            this._offsets = [],
            this._targets = [],
        ...
        return e.refresh = function() {
            var t = this
              , e = this._scrollElement === this._scrollElement.window ? Ti : xi
        ...
        ,
        e._getConfig = function(e) {
            if ("string" != typeof (e = l({}, ci, "object" == typeof e && e ? e : {})).target) {
                var t = p(e.target).attr("id");
                t || (t = g.getUID(si),
                p(e.target).attr("id", t)),
                e.target = "#" + t
            }
            return g.typeCheckConfig(si, e, fi),
            e
        }
        ,
        ...
        e._activate = function(t) {
            ...
            n.hasClass(di) ? (n.closest(bi).find(Ei).addClass(pi),
            n.addClass(pi)) : (n.addClass(pi),
            n.parents(mi).prev(vi + ", " + _i).addClass(pi),
            n.parents(mi).prev(yi).children(vi).addClass(pi)),
    ...
    p(window).on(hi.LOAD_DATA_API, function() {
        for (var e = [].slice.call(document.querySelectorAll(gi)), t = e.length; t--; ) {
            var n = p(e[t]);
            Ci._jQueryInterface.call(n, n.data())
        }
    }),
    p.fn[si] = Ci._jQueryInterface,
    p.fn[si].Constructor = Ci,
    ...
    var Si = "bs.tab"
      ...
      , Bi = function() {
        ...
        return e.show = function() {
            var n = this;
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(ki) || p(this._element).hasClass(Oi))) {
                var e, i, t = p(this._element).closest(Pi)[0], r = g.getSelectorFromElement(this._element);
                if (t) {
                    var o = "UL" === t.nodeName || "OL" === t.nodeName ? Ri : qi;
                    i = (i = p.makeArray(p(t).find(o)))[i.length - 1]
                }
                var s = p.Event(Ni.HIDE, {
                    relatedTarget: this._element
                })
                  , a = p.Event(Ni.SHOW, {
                    relatedTarget: i
        ...
        e._activate = function(e, t, n) {
            ...
            var r = this
              , o = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? p(t).children(qi) : p(t).find(Ri))[0]
              , s = n && o && p(o).hasClass(Li);
            if (o && s) {
        ...
        e._transitionComplete = function(e, t, n) {
            if (t) {
                p(t).removeClass(ki);
                var i = p(t.parentNode).find(Wi)[0];
            ...
            g.reflow(e),
            e.classList.contains(Li) && e.classList.add(ji),
            e.parentNode && p(e.parentNode).hasClass(Ii)) {
    ...
    p(document).on(Ni.CLICK_DATA_API, Mi, function(e) {
        e.preventDefault(),
        Bi._jQueryInterface.call(p(this), "show")
    }),
    ...
    var Ui = "toast"
      ...
      , tr = function() {
        ...
        e.hide = function(e) {
            var t = this;
            this._element.classList.contains(Xi) && (p(this._element).trigger(Vi.HIDE),
        ...
        e.dispose = function() {
            clearTimeout(this._timeout),
            this._timeout = null,
            this._element.classList.contains(Xi) && this._element.classList.remove(Xi),
        ...
        ,
        e._getConfig = function(e) {
            return e = l({}, Zi, p(this._element).data(), "object" == typeof e && e ? e : {}),
            g.typeCheckConfig(Ui, e, this.constructor.DefaultType),
            e
        }
        ,
        e._setListeners = function() {
            var e = this;
            p(this._element).on(Vi.CLICK_DISMISS, er, function() {
                return e.hide(!0)
            })
        }
        ,
        e._close = function() {
            function e() {
                ...
                p(t._element).trigger(Vi.HIDDEN)
            }
            var t = this;
            if (this._element.classList.remove(Xi),
            this._config.animation) {
                var n = g.getTransitionDurationFromElement(this._element);
    ...
    p.fn[Ui] = tr._jQueryInterface,
    p.fn[Ui].Constructor = tr,
